...
class TestVPCBuilderNACLParametersSetup(unittest.TestCase):
    identifier = "TEST"
...
class TestVPCBuilderNACLParameters(TestVPCBuilderNACLParametersSetup):

    def test_macro_networkacls_parameters(self):
                ...
                "Resources": {
                    "VPC": {
                        ...
                        "Properties": {
                            ...
                            "NetworkACLs": {
                                "InternalSubnetAcl": {
                                    "InternalSubnetAclEntryOutTCPUnreserved": "106,6,allow,true,VpcCidr,1024,65535",
                                    "InternalSubnetAclEntryOutUDPDNSIPv6": "113,17,allow,true,::/0,53,53",
                                    "InternalSubnetAclEntryOutUDPUnreserved": "107,6,allow,true,VpcCidr,1024,65535",
                                    "InternalSubnetAclEntryOut": "100,-1,allow,true,VpcCidr,1,65535",
                                    ...
                                    "InternalSubnetAclEntryIn": "100,-1,allow,false,VpcCidr,1,65535",
                                ...
                                "PublicSubnetAcl": {
                                    ...
                                    "RestrictedSubnetAclEntryOutPuppet": "94,6,allow,true,VpcCidr,8140,8140",
                                    "RestrictedSubnetAclEntryIn": "110,-1,allow,false,VpcCidr,1,65535",
                                    ...
                                    "RestrictedSubnetAclEntryInNetBios": "170,6,allow,false,VpcCidr,389,389",
                                    ...
                                    "RestrictedSubnetAclEntryInDNSTCP": "150,6,allow,false,VpcCidr,53,53",
                                    "RestrictedSubnetAclEntryOutUDPUnReservedIPv6": "93,17,allow,true,::/0,1024,65535",
                                    "RestrictedSubnetAclEntryOutNetBios1": "180,6,allow,true,VpcCidr,137,139",
                                    "RestrictedSubnetAclEntryOut": "110,-1,allow,true,VpcCidr,1,65535",
                                    ...
                                    "RestrictedSubnetAclEntryOutNetBios": "170,6,allow,true,VpcCidr,389,389",
                                    ...
                                    "RestrictedSubnetAclEntryInNetBios1": "80,6,allow,false,VpcCidr,137,139",
                                    ...
                                    "RestrictedSubnetAclEntryInDNSUDP": "160,17,allow,false,VpcCidr,53,53",
                                    "RestrictedSubnetAclEntryOutDNSUDPIPv6": "161,17,allow,true,::/0,53,53",
                                    "RestrictedSubnetAclEntryInSquid2": "140,6,allow,false,VpcCidr,3128,3128"
                                }
                            },
                            "SecurityGroups": {
                                "VPCEndpoint": {
